...
{
    class FirewallCell : Rule
    {
        public override void Apply(Prison prison)
        {
            FirewallCell.RemovePortAccess(prison.Rules.UrlPortAccess, true);
            FirewallCell.AddPortAccess(prison.Rules.UrlPortAccess, prison.User.Username);
        }
